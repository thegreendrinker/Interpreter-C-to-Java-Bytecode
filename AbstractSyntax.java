...
class Program {
	...
	decpart.display(Indent.INDENT);
	body.display(Indent.INDENT);
    }
...
class Declarations extends ArrayList<Declaration> {
    ...
    public ArrayList<Declaration> members = new ArrayList<Declaration>();

    void display(int numOfIndent) {
	    for(int i = 0; i < numOfIndent; ++i ) {
		System.out.print(" ");
	    }
	    System.out.println("Declarations: ");
	    for(int i = 0; i < numOfIndent + Indent.INDENT; ++i ) {
		    System.out.print(" ");
	    }
	    System.out.print("Declarations ={ ");
	    for( Declaration temp : members ) {
		    temp.display();
		    System.out.print(" ");
	    }
	    System.out.println("}");
...
abstract class Statement {
    ...
    abstract void display(int numOfIndent);
    abstract String strReturn();
}
...
class Block extends Statement { 
    ...
    void display(int numOfIndent) {
	    ...
	    for( Statement temp : members ) {
		    temp.display(numOfIndent + Indent.INDENT);
	    }
    }
...
class Assignment extends Statement {
    ...
    void display(int numOfIndent) {
	    ...
	    target.display(numOfIndent + Indent.INDENT);
	    source.display(numOfIndent + Indent.INDENT);
    }
...
// Conditional = Expression test; Statement thenbranch, elsebranch
    ...
    void display(int numOfIndent) {
	    ...
	    test.display(numOfIndent + Indent.INDENT);
	    thenbranch.display(numOfIndent + Indent.INDENT);
	    elsebranch.display(numOfIndent + Indent.INDENT);
    }

    String strReturn() {
	String testDisp = test.strReturn();
	return testDisp;
    }
...
// Loop = Expression test; Statement body
    ...
    void display(int numOfIndent) {
	    ...
	    test.display(numOfIndent + Indent.INDENT);
	    body.display(numOfIndent + Indent.INDENT);
    }
...
// Binary = Operator op; Expression term1, term2
    ...
    void display(int numOfIndent) {
	    ...
	    op.display(numOfIndent + Indent.INDENT);
	    term1.display(numOfIndent + Indent.INDENT);
	    term2.display(numOfIndent + Indent.INDENT);
    }
    ...
    String strReturn() {
	    String t1 = term1.strReturn();
	    String t2 = term2.strReturn();
	    String opDisp = op.strReturn();
	    String wholeOp = t1 + " " + opDisp + " " + t2;
	    return wholeOp;
    }
...
class Unary extends Expression {
    ...
    void display(int numOfIndent) {
	    ...
	    op.display(numOfIndent + Indent.INDENT);
	    term.display(numOfIndent + Indent.INDENT);
    }
...
class Operator {
    ...
    // Typed Operators
    // BoolOp = && | ||
    final static String AND_2 = "AND";
    final static String OR_2 = "OR";
    // RelationalOp = < | <= | == | != | >= | >
